...
// QRBarcodeReader.cpp: 애플리케이션에 대한 클래스 동작을 정의합니다.
...
BEGIN_MESSAGE_MAP(CQRBarcodeReaderApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CQRBarcodeReaderApp 생성

CQRBarcodeReaderApp::CQRBarcodeReaderApp()
{
...
// 유일한 CQRBarcodeReaderApp 개체입니다.

CQRBarcodeReaderApp theApp;


// CQRBarcodeReaderApp 초기화

BOOL CQRBarcodeReaderApp::InitInstance()//MFC 진입점. 메인함수. 
{
